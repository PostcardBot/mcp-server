...
exports.TOOLS = [
    {
        name: 'send_postcard',
        description: 'Send a physical postcard that will be printed and mailed to a real address. ' +
    ...
    {
        name: 'bulk_send',
        description: 'Send the same postcard to multiple recipients at once. Same message, image, and return address ' +
